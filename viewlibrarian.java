...
public class viewlibrarian extends javax.swing.JFrame {
     String a[]={"libname","libemail","libadd","libphone"};//here coloumn name of database
    ...
    public viewlibrarian() {
        String lname,lemail,ladd,lphone;
        initComponents();
        try{
              Class.forName("com.mysql.jdbc.Driver");
            Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/management", "root", "");
            Statement ss=con.createStatement();
            ResultSet rs=ss.executeQuery("select * from viewlibrarian");
            while(rs.next()){
                lname= rs.getString("libname");  //"name of column in database"
                 lemail=rs.getString("libemail");
ladd=rs.getString("libadd");
                 lphone=rs.getString("libphone");
                

                 Object o[]={lname,lemail,ladd,lphone};//data or variable store or declared
                 model.addRow(o);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 5, true), "VIEWLIBRARIAN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Algerian", 3, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Libraryname", "Librarianemail", "Librarian aaddress", "Librarian phone"
            }
        ));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 310, 710, 130));

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Win10\\Pictures\\lib.jpg")); // NOI18N
        jLabel2.setText("jLabel2");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 710, 580));

        jLabel1.setFont(new java.awt.Font("Algerian", 3, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("LIST FOR VIEWING LIBRARIAN");
        ...
        setSize(new java.awt.Dimension(805, 767));
